...
expName = 'vSearchNewAlpha4'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Andrew\\Documents\\Work\\Projects\\vSearchNewAlpha4\\vSearchNewAlpha4_lastrun.py',
...
for thisTaskLoop in taskLoop:
    ...
    if condsFile == "vSearch1Cond.xlsx":
        instrText.text = "In this task you will see sets of shapes made of four different shapes as outlined below. Only press the ‘s’ key if you see the upright “T” shape, which is the last shape. Otherwise, press the ‘k’ key. There will be 6, 12, or 18 shapes to observe in each trial. Press ‘enter’ to continue."
    elif condsFile == "vSearch2Cond.xlsx":
        instrText.text = "A quick break before the next set of trials. Remember, only press the ‘s’ key if you see the upright “T” shape, which is the last shape below. Otherwise, press the ‘k’ key. There will be 6, 12, or 18 shapes to observe in each trial. Press ‘enter’ to continue."
